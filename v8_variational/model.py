...
CONFIG = TrainConfig(
    name="v8_variational",
    model=PredictorConfig(latent_mode='variational', attention='content', mix_attention='similarity', cond_with_embedding=True, annotations=True, per_slot_head=True, text_memory=True, copy_path=True),

"""Cache the chain-of-thought annotations (Levels 6+), once per split.
...
Output: cache/annot_{split}.pt.  Run from the repository root: python -m storyseq.precompute.annotations
"""
...
from storyseq.precompute.parsing import _markdown_rows, parse_cot_grounding

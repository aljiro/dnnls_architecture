...
for component pretraining in the scaling stage: more frames for the visual autoencoder, more
captions for the text language model. No sequences, so it never touches the predictor's windows.

Output: poc/cache/groundcap.pt with
...
Run: python v2/precompute_groundcap.py
"""
...
from v2.data import T, tokenizer  # noqa: E402
